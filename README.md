# Task_manager_CRUD
Personal project for practice MongoDB and Mongoose for Node.js. <br/>
...
![Screenshot]([url=https://postimg.cc/3dkt75gH][img]https://i.postimg.cc/3dkt75gH/Screenshot-1.png[/img][/url])
